...
<nav class="container1">
    <div class="row">
        <button class="col reservation">
            <a href="../login/page_reg.php">REZERVACIJA</a>
        </button>
        <button class="col order">
            <a href="../login/page_reg.php">PORUDŽBINA</a>
        </button>
    </div>
</nav>
