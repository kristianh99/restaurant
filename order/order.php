...
<div class="container1 content">
    ...
    <div class="row shop-items">
        <div class="col-12 col-md-6 food shop-item">
...
<div class="container1 cart1" id="korpa">
    <div class="container content-section">
        <h2 class="section-header">Korpa</h2>
        <div class="cart-row">
            <span class="cart-item cart-header cart-column">STAVKA</span>
        ...
        <div class="cart-total">
            ...
            <span class="cart-total-price">0 din</span>
        </div>
        <div class="btn-p">
